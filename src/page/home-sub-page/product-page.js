...
export default class ProductComponent extends Component {
  ...
  setNewData() {
    ...
    itemList.push(this.showImage(this.state.currentPage));
  ...
  async getData() {
    await fetch(
      'https://www.fastmock.site/mock/1adff00ec21770e22911e12780c3f45a/foodMart/productList',
    )
        ...
        this.setState(
          {
            ...
            reachBottom:
              this.state.currentPage === responseJson.data.length - 1,
          },
          function() {},
        );
      })
  ...
  showImage(loadPageNumber) {
    return this.state.dataSource[loadPageNumber].map((item, index) => {
      return (
